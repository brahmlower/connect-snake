...
import { PlayerInput, SnakeControllerInput } from "../games";
...
export const ReactConnectSnake: React.FC<any> = () => {
  let [game, ] = useState<Snake>(new Snake())
  let [controller, setController] = useState<SnakeKeyboardController | null>(null)
