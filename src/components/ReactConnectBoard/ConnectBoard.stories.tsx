...
const BasicTemplate: ComponentStory<typeof ReactConnectBoard> = (args: ReactConnectBoardProps) => (<ReactConnectBoard {...args} />);
...
const ManualTestTemplate: ComponentStory<typeof ManualTestComponent> = (args: ManualTestComponentProps) => <ManualTestComponent {...args} />;
...
const LoopTestComponent: React.FC<LoopTestComponentProps> = (props: LoopTestComponentProps) => {
  ...
  const onIteration = () => {
    ...
    const newPosition = position === 41 ? 0 : position + 1;
